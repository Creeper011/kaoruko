...
from src.constants import DEFAULT_YAML_CONFIG_PATH, YAML_FILE_ENCODING

class YamlLoader():
    """Loader for yaml files"""

    def __init__(self, logger: Logger | None = None, config_path: Path = DEFAULT_YAML_CONFIG_PATH) -> None:
